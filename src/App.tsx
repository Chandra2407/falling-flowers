    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-sky-200 to-sky-400">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <button
          ...
          className="px-20 py-2 bg-gradient-to-t from-green-600 to-green-500 text-white rounded-full shadow-md hover:shadow-lg hover:scale-105 transition-transform border border-green-700"
        >
          <svg
